package com.counter.taskandroidcomposestate
...
import com.counter.taskandroidcomposestate.ui.theme.TaskAndroidComposeStateTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            TaskAndroidComposeStateTheme {
